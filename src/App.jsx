...
const App = () => {
  ...
  const handleSelectOption = (selectedOption) => {
    ...
    if (!isHandoffSuccess) {
      ...
      // Immediate transition if no speech (e.g. Handoff success)
  ...
  const handleEndGameContinue = () => {
    ...
    if (selectedLevel.id === 'rainy' && currentNode.result === 'success') {
      setGameState('FINAL_SUCCESS');
    } else {
      ...
      <div className="game-container min-h-screen w-full bg-slate-900 text-white overflow-hidden relative flex flex-col items-center justify-center p-8">
        ...
        <div className="relative z-10 max-w-2xl w-full flex flex-col items-center text-center animate-fade-in-up">
          ...
          <button
            onClick={() => {
              setGameState('START');
              setCompletedLevels([]); // Optional: Reset or keep
              audioManager.playVictory();
            }}
